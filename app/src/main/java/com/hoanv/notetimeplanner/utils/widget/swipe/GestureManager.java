package com.hoanv.notetimeplanner.utils.widget.swipe;
...
public class GestureManager extends ItemTouchHelper.SimpleCallback {
    ...
    private final int STANDARD_TEXT_SIZE = 40;
    ...
    private void drawLeftLayout(Canvas canvas, View itemView, float dX) {
        ...
        if (swipeCallbackLeft != null) {
            ...
            if (drawableLeft != null) {
                ...
                int boundRight = itemView.getRight() - margin - margin;
                int boundLeft = boundRight - drawableWidth;
                int boundTop = itemView.getTop() + (itemView.getHeight() - drawableHeight) / 4;
                int boundBottom = itemView.getBottom() - (itemView.getHeight() - drawableHeight) / 2 - 45;
    ...
    private void drawTextLeft(Canvas canvas, View itemView, double marginRight) {
        ...
        float x = (float) (itemView.getRight() - marginRight - marginRight - 6);
        float y = itemView.getBottom() - marginBottom;
    ...
    private void drawRightLayout(Canvas canvas, View itemView, float dX) {
        ...
        if (swipeCallbackRight != null) {
            ...
            if (drawableRight != null) {
                ...
                int drawableHeight = drawableLeft.getIntrinsicHeight() * iconSizeMultiplier;
                int drawableWidth = drawableLeft.getIntrinsicWidth() * iconSizeMultiplier;
                int boundLeft = itemView.getLeft() + margin + margin;
    ...
    private void drawTextRight(Canvas canvas, View itemView, double marginLeft) {
        ...
        //calculating values
        float marginBottom = 70;
        float x = (float) (itemView.getLeft() + marginLeft - 10);
        float y = itemView.getBottom() - marginBottom;
     ...
     *
     * @param weight An integer which changes the stroke of the text paint
     */
     ...
     *
     * @param weightLeft  An integer which changes the stroke of the text paint
     * @param weightRight An integer which changes the stroke of the text paint
     */
